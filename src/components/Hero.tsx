    ...
    <>
      <div className="flex flex-col justify-evenly gap-4 items-center h-screen ">
        ...
        <div className=" flex gap-2">
          <button className="btn btn-outline uppercase btn-secondary" onClick={() => { router.push('/') }}>Sign in</button>
          <button className="btn btn-outline uppercase btn-primary" onClick={() => { router.push('/') }}>
            Sign in with google
          </button>
        </div>
      </div>
